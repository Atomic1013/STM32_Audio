...
/**
  * @简介  设置Line输入通道的增益
  * @参数  _ucGain 增益值, 0-7. 7最大，0最小。 可衰减可放大。
  * @返回  无
  */
...
/**
  * @简介  设置陷波滤波器（notch filter），主要用于抑制话筒声波正反馈，避免啸叫
  * @参数  NFA0[13:0] and NFA1[13:0]
  * @返回  无
  */
...
/**
  * @简介  控制WM8978的GPIO1引脚输出0或1，控制模拟开关来切换录音放音
  * @参数  _ucValue GPIO1输出值，0或1
  * 				1：放音
  * 				0：录音
  * @返回  无
  */
